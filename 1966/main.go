...
// func (pq *PrintQueue) InitPrintQueue() {
// 	for p := pq.v.Front(); p != nil; p = p.Next() {
// 		if p.Value.(Docs).importance > pq.v.Front().Value.(Docs).importance {
// 			for q := pq.v.Front(); q != p; {
// 				q = q.Next()
// 				pq.v.MoveToBack(q.Prev())
// 			}
// 			pq.InitPrintQueue()
// 		}
// 	}
